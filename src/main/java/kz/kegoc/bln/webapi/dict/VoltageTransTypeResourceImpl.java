...
public class VoltageTransTypeResourceImpl {
	...
	public VoltageTransTypeResourceImpl() {
		mapper = new DozerBeanMapper();
		mapper.setMappingFiles(Arrays.asList("mapping/dict/VoltageTransTypeDtoDefaultMapping.xml"));
	} 
	...
	public Response getByCode(@PathParam("code") String code) {		
		VoltageTransType entity = service.findByCode(code);
		return Response.ok()
			.entity(mapper.map(entity, VoltageTransTypeDto.class))
			.build(); 
	}
	...
	public Response getByName(@PathParam("name") String name) {		
		VoltageTransType entity = service.findByName(name);
		return Response.ok()
			.entity(mapper.map(entity, VoltageTransTypeDto.class))
			.build();
	}
	...
	@Inject private VoltageTransTypeService service;
