...
public class PowerTransformerServiceImpl extends AbstractEntityService<PowerTransformer> implements PowerTransformerService {
	...
	@Inject
    public PowerTransformerServiceImpl(Repository<PowerTransformer> repository, Validator validator, Filter<PowerTransformer> prePersistFilter, Translator<PowerTransformer> translator) {
