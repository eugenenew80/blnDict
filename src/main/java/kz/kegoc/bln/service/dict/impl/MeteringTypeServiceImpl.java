...
public class MeteringTypeServiceImpl extends AbstractEntityService<MeteringType> implements MeteringTypeService {
	...
	@Inject
    public MeteringTypeServiceImpl(Repository<MeteringType> repository, Validator validator, Filter<MeteringType> prePersistFilter, Translator<MeteringType> translator) {
