...
public class EnergySourceServiceImpl extends AbstractEntityService<EnergySource>
	...
	@Inject
    public EnergySourceServiceImpl(EnergySourceRepository repository, Validator validator, Filter<EnergySource> prePersistFilter, Translator<EnergySource> translator) {
