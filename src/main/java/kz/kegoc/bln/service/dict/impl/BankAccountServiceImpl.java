...
public class BankAccountServiceImpl extends AbstractEntityService<BankAccount> implements BankAccountService {
	@Inject
    public BankAccountServiceImpl(Repository<BankAccount> repository, Validator validator, Filter<BankAccount> prePersistFilter, Translator<BankAccount> translator) {
