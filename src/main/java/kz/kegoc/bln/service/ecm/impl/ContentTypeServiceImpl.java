...
public class ContentTypeServiceImpl extends AbstractEntityService<ContentType> implements ContentTypeService {
	@Inject
    public ContentTypeServiceImpl(Repository<ContentType> repository, Validator validator, Filter<ContentType> prePersistFilter, Translator<ContentType> translator) {
